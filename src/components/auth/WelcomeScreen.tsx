        ...
        <ProxCard className="w-full max-w-md mx-auto text-center bg-transparent border-none shadow-none">
          <ProxCardHeader>
            ...
            <p className="text-white/70 text-sm font-bold">
              Save up to $2,500 per year by finding the lowest prices on the
              products you love.
            </p>
          </ProxCardHeader>
          ...
          <ProxCardContent className="space-y-4">
            ...
            <p className="text-xs text-white/70 font-bold pb-4">
              Guest mode stores data locally only. Create an account to sync
              across devices and enable notifications.
            </p>
          </ProxCardContent>
        </ProxCard>
      </div>
